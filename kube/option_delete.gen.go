...
var deleteOptions = []prompt.Suggest{
	prompt.Suggest{Text: "--all", Description: "Delete all resources, in the namespace of the specified resource types."},
	...
	prompt.Suggest{Text: "--wait", Description: "If true, wait for resources to be gone before returning. This waits for finalizers. Usage:\n  kubectl delete ([-f FILENAME] | [-k DIRECTORY] | TYPE [(NAME | -l label | --all)]) [options] Use \"kubectl options\" for a list of global command-line options (applies to all commands)."},
}

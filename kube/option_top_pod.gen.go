...
var topPodOptions = []prompt.Suggest{
	...
	prompt.Suggest{Text: "--sum", Description: "Print the sum of the resource usage"},
	prompt.Suggest{Text: "--use-protocol-buffers", Description: "Enables using protocol-buffers to access Metrics API. Usage:\n  kubectl top pod [NAME | -l label] [options] Use \"kubectl options\" for a list of global command-line options (applies to all commands)."},
}

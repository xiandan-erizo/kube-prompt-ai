...
var rolloutUndoOptions = []prompt.Suggest{
	...
	prompt.Suggest{Text: "--to-revision", Description: "The revision to rollback to. Default to 0 (last revision). Usage:\n  kubectl rollout undo (TYPE NAME | TYPE/NAME) [flags] [options] Use \"kubectl options\" for a list of global command-line options (applies to all commands)."},
}

...
var patchOptions = []prompt.Suggest{
	...
	prompt.Suggest{Text: "--subresource", Description: "If specified, patch will operate on the subresource of the requested object. Must be one of [status scale]. This flag is alpha and may change in the future."},
	...
	prompt.Suggest{Text: "--type", Description: "The type of patch being provided; one of [json merge strategic] Usage:\n  kubectl patch (-f FILENAME | TYPE NAME) [-p PATCH|--patch-file FILE] [options] Use \"kubectl options\" for a list of global command-line options (applies to all commands)."},
}

...
var proxyOptions = []prompt.Suggest{
	...
	prompt.Suggest{Text: "--append-server-path", Description: "If true, enables automatic path appending of the kube context server path to each request."},
	...
	prompt.Suggest{Text: "-P", Description: "Prefix to serve static files under, if static file directory is specified. Usage:\n  kubectl proxy [--port=PORT] [--www=static-dir] [--www-prefix=prefix] [--api-prefix=prefix] [options] Use \"kubectl options\" for a list of global command-line options (applies to all commands)."},
	prompt.Suggest{Text: "--www-prefix", Description: "Prefix to serve static files under, if static file directory is specified. Usage:\n  kubectl proxy [--port=PORT] [--www=static-dir] [--www-prefix=prefix] [--api-prefix=prefix] [options] Use \"kubectl options\" for a list of global command-line options (applies to all commands)."},
}
